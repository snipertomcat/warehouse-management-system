...
--
-- Host: localhost:8889
-- Generation Time: Mar 28, 2019 at 01:52 AM
...
CREATE TABLE `deliveries` (
  ...
  `status` enum('processing','shipping','complete') COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
ALTER TABLE `deliveries`
  ADD CONSTRAINT `deliveries_sale_id_foreign` FOREIGN KEY (`sale_id`) REFERENCES `sales` (`id`);
